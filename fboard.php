...
<?php
  ...
  $result = mysql_query("SELECT * FROM freeB WHERE freeB_type='fboard' order by freeB_no desc");
?>
<!DOCTYPE HTML>
                      ...
                      <tbody>
                        <?php
                          ...
                          <tr>
                            ...
                            <td><a href="view.php?no=<?php echo $row['freeB_no'];?>&type=freeB_type&typeN=fboard"><?php echo $row['freeB_title'];?></a></td>
